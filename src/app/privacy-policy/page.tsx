...
const url = new URL('https://www.poscidondao.com/privacy-policy');
...
export default function Policy() {
  return (
    ...
    >
      ...
      <ul className="list-decimal pl-4 marker:font-proximaBold">
        <li>
          <h4>Personal data</h4>
          <p>
      ...
      <h2 className="py-2 font-proximaBold text-2xl ">2. Name and Address of the controller</h2>
      <p>
      ...
      <h2 className="py-2 font-proximaBold text-2xl">8. Routine erasure and blocking of personal data</h2>
      <p>
      ...
      <h2 className="py-2 font-proximaBold text-2xl">9. Rights of the data subject</h2>
      <ul className="list-decimal pl-4 marker:font-proximaBold">
        <li>
      ...
      <h2 className="py-2 font-proximaBold text-2xl">12. Legal basis for the processing </h2>
      <p>
      ...
      <h2 className="py-2 font-proximaBold text-2xl">
      ...
      <h2 className="py-2 font-proximaBold text-2xl">14. Period for which the personal data will be stored</h2>
      <p>
      ...
      <h2 className="py-2 font-proximaBold text-2xl">16. Existence of automated decision-making</h2>
      <p>
      ...
      <p>
        ...
        <a href="https://abletotrack.com/">timesheet tracker</a>. The legal
